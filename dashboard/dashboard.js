...
// ── SCRIPT_URL يُجلب من config.js (محمّل في head) ────────────
var SCRIPT_URL = (typeof window !== 'undefined' && window.SCRIPT_URL) ? window.SCRIPT_URL : '';
...
window.addEventListener('load', function() {
  // قراءة SCRIPT_URL من config.js (تم تحميله في <head>)
